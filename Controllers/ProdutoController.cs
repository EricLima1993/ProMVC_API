...
namespace ProMVC_API.Controllers
{
    ...
    public class ProdutoController : ControllerBase
    {
        ...
        // GET: api/Produto
        [HttpGet]
        public async Task<ActionResult<IEnumerable<ProdutoModel>>> GetProduto()
        {
        ...
        {
            var produtoModel = await _context.Produto.Include("Categoria").FirstOrDefaultAsync(x => x.Id == id);
